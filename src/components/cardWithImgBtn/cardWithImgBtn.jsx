...
import "./cardWithImgBtn.css";
const CardWithImgBtn = ({ title, subtitle, img, width, height, position }) => {
  return (
    <div className="flex items-start" style={{ width: width, height: height }}>
      {position == "left" ? (
        <img
          className="img-custom object-cover shadow-md"
          src={img}
          alt={img}
        />
      ) : (
